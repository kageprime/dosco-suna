...
- The **`kortix_permissions` grant** (Dosco permissions) is declared per agent in
  ...
  agents:
    kortix:
      ...
      kortix_permissions: all  # which Dosco platform actions it may perform
    release-bot:
...
- **Edit in the dashboard:** Customize → Agents → the agent → **Dosco permissions**
