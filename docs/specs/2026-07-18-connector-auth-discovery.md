...
Connector sources already describe authentication. Dosco must preserve and use
...
- Every discovered scheme is returned to callers. Dosco recommends and applies
