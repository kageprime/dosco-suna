...
• 1. What changed
     ...
     Main fixes:
      ...
      - Connector principal resolution now uses token session context, not only X-Dosco-Session-Id.
...
Dosco-CLI grants, while unlisted agents become default-deny. The effective
...
Dosco decides what may be generated.
