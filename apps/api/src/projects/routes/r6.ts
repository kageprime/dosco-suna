    ...
    return c.json(
      {
        ...
        message: emailConfigured
          ? `No Dosco account for that email yet — an invitation email has been sent. After they sign up, Dosco shows them the invite and they join this project as ${role}.`
          : `No Dosco account for that email yet — invitation created. Share the invite link with them. After they sign up, Dosco shows them the invite and they join this project as ${role}.`,
      },
      201,
    );
  }
