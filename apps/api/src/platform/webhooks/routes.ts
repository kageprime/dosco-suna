...
import { handleDaytonaWebhook, handleE2bWebhook, handlePlatinumWebhook } from './sandbox-webhooks';
...
sandboxWebhooksApp.openapi(
  createRoute({
    ...
    path: '/e2b',
    tags: ['webhooks'],
    summary: 'E2B sandbox lifecycle webhook (base64 sha256(secret + body), public)',
    responses: {
      200: json(z.record(z.string(), z.any()), 'Webhook processing result'),
      ...errors(400, 401, 503),
    },
