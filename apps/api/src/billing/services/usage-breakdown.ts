 ...
 *
 * `usage` is what the router writes for a Dosco tool call — deliberately not
 ...
 * vanished from the total. On the production Dosco account that is 10,859 rows.
 *
 ...
 * Dosco account the anchor is 2026-06-07, two months stale.
 *
