...
description: Connect your machine through the permissioned Agent Tunnel.
---
...
sandbox is a disposable cloud machine that the platform creates for a
...
grant is a per-resource setting on one machine, not a role. It grants no
