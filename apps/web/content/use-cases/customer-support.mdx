...
description: The support agent we run on Dosco — connected to Plain, our codebase, and Stripe. It triages and resolves inbound threads, and stops for human approval on anything sensitive.
date: "2026-07-03"
author: team
tags:
  - Customer Support
...
We run our own customer support on Dosco with an AI agent connected to Plain
...
Our support inbox in **Plain** is connected to an agent running on Dosco. Every
...
security question as much as a product one. The controls on Dosco:
