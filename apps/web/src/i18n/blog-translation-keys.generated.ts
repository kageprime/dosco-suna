// Generated from blog post titles and descriptions.
export const BLOG_TRANSLATION_KEYS: Readonly<Record<string, string>> = {
  ...
  'Build a business that compounds': 'text2ea6d76002f7',
  'Build for the jump, not the model.': 'text1c4642fde099',
  'Build the client workspace as files, then run it with agents.': 'textb3432a9b2814',
  ...
  "Claude Cowork is the best agent on the desktop. But it runs one assistant per person, on Anthropic's models, with your data on their cloud. Here's where you outgrow it — and what an open, company-wide agent platform looks like.":
    'text6adbb84fd784',
  'Compared here:': 'textcdd43080fef2',
  ...
  'Satya Nadella’s frontier-ecosystem framework reveals the most important strategic idea in AI: every company must build human capital and token capital, and they compound together.':
    'text2366b8e06afa',
  'Start building your learning loop today.': 'text7eeb9965afc9',
  'Start building your token capital': 'textc7dd424e265c',
  'Start with one department, connect the tools it already uses, and turn the workflow into a Git-backed AI command center the client can own.':
    'text8cc3665e5926',
  'Start with one job, connect the tools it needs, and reach it from Slack, the web or the CLI. Free to start, free to self-host.':
    'text54529c95dca9',
  'Start with one workflow, grant only the connectors it needs, gate risky actions, and run the work from a repo your company owns.':
    'textb1ccf8b4bf1f',
  'Static software is dead: the shift from code to feedback loops': 'texte2d30ca7f79e',
  'Stop building static software. Start building feedback loops.': 'textf3d4c9b3357c',
  'The architecture is a commodity. The learning loop is the differentiator.': 'text3506a35e7669',
  'The first phase of globalization hollowed out industrial economies. The AI era cannot repeat that. The priority has to be building a frontier ecosystem, not just a frontier model.':
    'textdfe40a843c41',
  'The frontier ecosystem needs builders': 'textafe8ed437ba3',
