...
describe('promptFromSearchParams', () => {
  ...
  test('decodes URL-encoded characters', () => {
    ...
    params.set('q', 'Read https://dosco.example.com/docs/sdk so I can ask questions about it.');
    expect(promptFromSearchParams(params)).toBe(
      'Read https://dosco.example.com/docs/sdk so I can ask questions about it.',
    );
  });
});
