  ...
  const tools: ModelContextTool[] = [
    {
      ...
      description: 'Search Dosco public documentation and product content.',
      inputSchema: {
        type: 'object',
        properties: {
    ...
    },
    {
      ...
      description: 'Read a Dosco public page as Markdown.',
      inputSchema: {
        type: 'object',
        properties: {
          path: {
            type: 'string',
            pattern: '^/(?!/)',
            description: 'Dosco path from a search result.',
          },
        },
        required: ['path'],
        additionalProperties: false,
