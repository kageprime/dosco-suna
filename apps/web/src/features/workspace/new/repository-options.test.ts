...
describe('gitAccountOptions: connections first, Dosco managed last', () => {
...
describe('defaultGitAccount: the connection, not the fallback', () => {
  ...
  test('defaults to Dosco managed only when there is no connection', () => {
...
describe('withGitAccount / withRepositoryAction: two controls over one state', () => {
  ...
  test('switching to Dosco managed drops the installation and the action', () => {
  ...
  test('the action is a no-op for Dosco managed, which has none', () => {
