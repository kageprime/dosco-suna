 ...
 * this Dosco account has connected, then `Dosco managed` (the instance's
 ...
 * repository, or import one that exists. `Dosco managed` has no action.
 *
 ...
 * five rows that read as a repository menu, and the Dosco ACCOUNT the
 ...
 * defaults to its connection and an unconnected one to `Dosco managed`.
 *
