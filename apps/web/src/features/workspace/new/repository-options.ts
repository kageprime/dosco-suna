 ...
 * account or organization the Dosco account has connected, or `Dosco
 ...
 * deterministic); `Dosco managed` is one option at the END and never reads as
...
/**
 * Every git account this Dosco account can put a repository under, in
 * display order.
 *
 ...
 * has one, `Dosco managed` otherwise.
 *
