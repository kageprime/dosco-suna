 ...
 *
 *   Dosco permissions (kortix.yaml) ∩ ceiling role (IAM) − human-only
 *
 * With the project flag `agent_principal` off, the old rule applies — the
 * launcher's project role intersected with the Dosco permissions — and the
 * card says so instead of pretending to know who will launch the agent.
 *
 * Read-only. The Dosco permissions are edited on the same tab (the checklist
