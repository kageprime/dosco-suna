...
export const SessionLayout = memo(function SessionLayout({
  ...
  //
  // `continuity` names the project session behind this layout id and
  // whether this mount is the transient boot shell. The store uses it for one
  // thing: the boot→ready crossfade renames the layout from the session
  ...
  //
  // A transient sub-session has no session row for `/turn` to answer
  ...
  // While booting, the panel is JUST the dead-center "Computer is
